/**
 * Hookline Email Analyzer
 *
 * Pure analysis logic — no DOM access, no Chrome APIs.
 * Takes extracted email data, runs all detection rules,
 * and returns a structured EmailAnalysisResult.
 *
 * This is the core of Phase 3. It is fully unit-testable
 * because it has zero side effects.
 */
...
export function analyzeLink(
  ...
  if (senderDomain && domain && domain !== senderDomain) {
